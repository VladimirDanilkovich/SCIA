...
describe('Phone response method', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('Phone response method', async function() {
    ...
    await driver.findElement(By.css(".ng-scope > .form-control")).sendKeys("1234566755")
    {
